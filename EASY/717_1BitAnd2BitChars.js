...
console.log(isOneBitCharacter([0,0,0,0,0,0])); // true
console.log(isOneBitCharacter([1,1,1,1,0])); // true
console.log(isOneBitCharacter([1,0,1,0,1,0,0])); // true
console.log(isOneBitCharacter([0,1,1,0,1,0,0])); // true


console.log(isOneBitCharacter([1,0,1,0,1,0])); // false
console.log(isOneBitCharacter([0,1,0])); // false
console.log(isOneBitCharacter([1,0])); // false
console.log(isOneBitCharacter([])); // false